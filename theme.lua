...
theme.fg_focus      = "#ff6e67" -- dracula bright red
...
theme.taglist_bg_focus = "#444444" -- previously theme.bg_focus
-- https://awesomewm.org/doc/api/classes/awful.widget.tasklist.html#beautiful.tasklist_disable_icon
